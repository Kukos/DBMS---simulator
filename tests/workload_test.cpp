...
GTEST_TEST(workloadTestRaw, interface)
{
...
GTEST_TEST(workloadTestRaw, singleStepInsert)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, singleStepBulkload)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, singleStepDelete)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, singleStepPSearch)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, singleStepRSearch)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, multiSteps)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, copy)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestRaw, move)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, interface)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();

    PhantomIndex* ph = new PhantomIndex(disk, true);
    DBIndexColumn* index = new DBIndexRawToColumnWrapper(ph, std::vector<size_t>{8, 16, 32, 4, 4, 8});

    DSM* dsm = new DSM(disk2, std::vector<size_t>{8, 16, 32, 4, 4, 8});
    DBIndexColumn* index2 = dsm;
...
GTEST_TEST(workloadTestColumn, singleStepInsert)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, singleStepBulkload)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, singleStepDelete)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, singleStepPSearch)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, singleStepRSearch)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
    ...
    steps.push_back(new WorkloadStepRSearch(static_cast<size_t>(50), std::vector<size_t>{0, 2, 3, 4}, 100));
    Workload w(indexes, steps);
...
GTEST_TEST(workloadTestColumn, multiSteps)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, copy)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(workloadTestColumn, move)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();

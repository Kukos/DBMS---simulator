...
GTEST_TEST(analyzerStepQueryWearoutTestRaw, interface)
{
    ...
    WorkloadAnalyzerStepQueryWearout analyzer;
    EXPECT_EQ(analyzer.getName(), std::string("QueryWearout"));
...
GTEST_TEST(analyzerStepQueryWearoutTestRaw, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepQueryWearoutTestColumn, interface)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepQueryWearoutTestColumn, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();

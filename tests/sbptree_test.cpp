...
GTEST_TEST(sbptreeBasicSSDTest, interface)
{
    ...
    SBPTree* sbp = new SBPTree(disk, keySize, dataSize, nodeSize);
    DBIndex* index = sbp;
...
GTEST_TEST(sbptreeBasicSSDTest, copy)
{
    ...
    SBPTree* bp = new SBPTree(disk, keySize, dataSize, nodeSize, true);
    DBIndex* index = bp;
    ...
    SBPTree* copy = new SBPTree(*dynamic_cast<SBPTree*>(index));
...
GTEST_TEST(sbptreeBasicSSDTest, move)
{
    Disk* disk = new DiskSSD_Samsung840();
    ...
    SBPTree* copy = new SBPTree(std::move(*dynamic_cast<SBPTree*>(index)));
    EXPECT_EQ(copy->getKeySize(), keySize);
    EXPECT_EQ(copy->getDataSize(), dataSize);
    EXPECT_EQ(copy->getRecordSize(), recordSize);
    EXPECT_EQ(copy->isBulkloadSupported(), true);
...
GTEST_TEST(sbptreeBasicSSDTest, insertIntoRoot)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, insertToInner)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, singleBulkload)
{
    Disk* disk = new DiskSSD_Samsung840();
    ...
    SBPTree* sbp = new SBPTree(disk, keySize, dataSize, nodeSize, true);
    DBIndex* index = sbp;
    ...
    EXPECT_EQ(sbp->getHeight(), 3);

    delete index;
}

GTEST_TEST(sbptreeBasicSSDTest, severalBulkloads)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, findPointInRoot)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, findPointInBigTree)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, findRangeInRoot)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, findRangeInBigTree)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, deleteFromRoot)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicSSDTest, deleteFromInner)
{
    Disk* disk = new DiskSSD_Samsung840();
...
GTEST_TEST(sbptreeBasicPCMTest, interface)
{
...
GTEST_TEST(sbptreeBasicPCMTest, insertIntoRoot)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, insertIntoInner)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, singleBulkload)
{
    Disk* disk = new DiskPCM_DefaultModel();
    ...
    EXPECT_EQ(sbp->getHeight(), 4);

    delete index;
}

GTEST_TEST(sbptreeBasicPCMTest, severalBulkloads)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, findPointInRoot)
{
    Disk* disk = new DiskPCM_DefaultModel();
    ...
    for (size_t i = 0; i < numOperations; ++i)
    {
        EXPECT_DOUBLE_EQ(index->findPointEntries(), 6.0 * readTime);
        EXPECT_DOUBLE_EQ(index->findPointEntries(static_cast<size_t>(5)), 5.0 * 6.0 * readTime);
        EXPECT_NEAR(index->findPointEntries(0.1), (numOperations / 10) * 6.0 * readTime, 0.0001);
        EXPECT_NEAR(index->findPointEntries(0.1, 2), 2.0 * (numOperations / 10) * 6.0 * readTime, 0.0001);

        sumTime += 6.0 * readTime + 5.0 * 6.0 * readTime + (numOperations / 10) * 6.0 * readTime + 2.0 * (numOperations / 10) * 6.0 * readTime;
...
GTEST_TEST(sbptreeBasicPCMTest, findPointInBigTree)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, findRangeInRoot)
{
    Disk* disk = new DiskPCM_DefaultModel();
    ...
    for (size_t i = 0; i < numOperations; ++i)
    {
        EXPECT_DOUBLE_EQ(index->findRangeEntries(static_cast<size_t>(5)), 6.0 * readTime + 8.0 * readTime);
        EXPECT_DOUBLE_EQ(index->findRangeEntries(static_cast<size_t>(5), 2), 2.0 * (6.0 * readTime + 8.0 * readTime));
        EXPECT_DOUBLE_EQ(index->findRangeEntries(nodeSize / recordSize), 6.0 * readTime + 8.0 * readTime);
        EXPECT_DOUBLE_EQ(index->findRangeEntries(0.5), 6.0 * readTime + 8.0 * readTime);
        EXPECT_DOUBLE_EQ(index->findRangeEntries(0.5, 2), 2.0 * (6.0 * readTime + 8.0 * readTime));

        sumTime += 6.0 * readTime + 8.0 * readTime + 2.0 * (6.0 * readTime + 8.0 * readTime) + 6.0 * readTime + 8.0 * readTime + 6.0 * readTime + 8.0 * readTime +  2.0 * (6.0 * readTime + 8.0 * readTime);
...
GTEST_TEST(sbptreeBasicPCMTest, findRangeInBigTree)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, deleteFromRoot)
{
    Disk* disk = new DiskPCM_DefaultModel();
...
GTEST_TEST(sbptreeBasicPCMTest, deleteFromInner)
{
    Disk* disk = new DiskPCM_DefaultModel();

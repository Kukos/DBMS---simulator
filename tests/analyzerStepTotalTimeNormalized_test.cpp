...
GTEST_TEST(analyzerStepTotalTimeNormalizedTestRaw, interface)
{
    ...
    WorkloadAnalyzerStepTotalTimeNormalized analyzer;
    EXPECT_EQ(analyzer.getName(), std::string("TotalTimeNormalized"));
...
GTEST_TEST(analyzerStepTotalTimeNormalizedTestRaw, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepTotalTimeNormalizedTestColumn, interface)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepTotalTimeNormalizedTestColumn, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();

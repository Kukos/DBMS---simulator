...
GTEST_TEST(analyzerStepQueryTimeNormalizedTestRaw, interface)
{
    ...
    WorkloadAnalyzerStepQueryTimeNormalized analyzer;
    EXPECT_EQ(analyzer.getName(), std::string("QueryTimeNormalized"));
...
GTEST_TEST(analyzerStepQueryTimeNormalizedTestRaw, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepQueryTimeNormalizedTestColumn, interface)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();
...
GTEST_TEST(analyzerStepQueryTimeNormalizedTestColumn, analyze)
{
    Disk* disk = new DiskSSD_Samsung840();
    Disk* disk2 = new DiskSSD_Samsung840();

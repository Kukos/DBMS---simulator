...
size_t BPTree::calculateNumOfNodes() const noexcept(true)
{
    return calculateNumOfInners() + calculateNumOfLeaves();
}

size_t BPTree::calculateNumOfInners() const noexcept(true)
{
...
size_t BPTree::calculateNumOfLeaves() const noexcept(true)
{
    return calculateNumOfLeavesForEntries(numEntries, sizeRecord);
}

size_t BPTree::calculateNumOfLeavesForEntries(size_t numEntries, size_t entrySize) const noexcept(true)
{
...
size_t BPTree::calculateHeight() const noexcept(true)
{
    if (numEntries == 0)
        return 0;
...
double BPTree::findLeaf() noexcept(true)
{
    double time = 0.0;
...
double BPTree::insertEntriesHelper(size_t numOperations) noexcept(true)
{
    double time = 0.0;
...
double BPTree::bulkloadEntriesHelper(size_t numEntries) noexcept(true)
{
    double time = 0.0;
...
double BPTree::deleteEntriesHelper(size_t numOperations) noexcept(true)
{
    double time = 0.0;
...
double BPTree::findEntriesHelper(size_t numEntries, size_t numOperations) noexcept(true)
{
    double time = 0.0;
...
BPTree::BPTree(const char*name, Disk* disk, size_t sizeKey, size_t sizeData, size_t nodeSize, bool isSpecialBulkloadFeatureOn)
...
{
    LOGGER_LOG_DEBUG("BPTree created {}", toStringFull());
}


BPTree::BPTree(Disk* disk, size_t sizeKey, size_t sizeData, size_t nodeSize, bool isSpecialBulkloadFeatureOn)
: BPTree("B+Tree", disk, sizeKey, sizeData, nodeSize, isSpecialBulkloadFeatureOn)
{

}

BPTree::BPTree(Disk* disk, size_t sizeKey, size_t sizeData, bool isSpecialBulkloadFeatureOn)
: BPTree(disk, sizeKey, sizeData, disk->getLowLevelController().getPageSize(), isSpecialBulkloadFeatureOn)
{

}

BPTree::BPTree(const char* name, Disk* disk, size_t sizeKey, size_t sizeData, bool isSpecialBulkloadFeatureOn)
: BPTree(name, disk, sizeKey, sizeData, disk->getLowLevelController().getPageSize(), isSpecialBulkloadFeatureOn)
{

}

size_t BPTree::getHeight() const noexcept(true)
{
    return height;
}

bool BPTree::isBulkloadSupported() const noexcept(true)
{
...
double BPTree::insertEntries(size_t numOperations) noexcept(true)
{
...
double BPTree::bulkloadEntries(size_t numEntries) noexcept(true)
{
...
double BPTree::deleteEntries(size_t numOperations) noexcept(true)
{
...
double BPTree::findPointEntries(size_t numOperations) noexcept(true)
{
...
double BPTree::findPointEntries(double selectivity, size_t numOperations) noexcept(true)
{
...
double BPTree::findRangeEntries(size_t numEntries, size_t numOperations) noexcept(true)
{
...
double BPTree::findRangeEntries(double selectivity, size_t numOperations) noexcept(true)
{
...
std::string BPTree::toString(bool oneLine) const noexcept(true)
{
    if (oneLine)
        return std::string(std::string("BPTree {") +
...
std::string BPTree::toStringFull(bool oneLine) const noexcept(true)
{
    if (oneLine)
        return std::string(std::string("BPTree {") +
                           std::string(" .sizeKey = ") + std::to_string(sizeKey) +

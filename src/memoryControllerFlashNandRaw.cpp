...
MemoryControllerFlashNandRaw::MemoryControllerFlashNandRaw(MemoryModelFlashNandRaw* flash)
: MemoryController(flash, flash->getPageSize(), flash->getBlockSize())
{
    LOGGER_LOG_DEBUG("Memory controller FlashNandRaw created: {}", toStringFull());
}

std::string MemoryControllerFlashNandRaw::toString(bool oneLine) const noexcept(true)
{
    if (oneLine)
        return std::string(std::string("MemoryControllerFlashNandRaw {") +
...
std::string MemoryControllerFlashNandRaw::toStringFull(bool oneLine) const noexcept(true)
{

...
class CBPTree : public DBIndex
{
protected:
    static constexpr size_t overflowMaxNumber = 4;
    size_t nodeSize;
    size_t sizePtr;
    size_t height;
    bool isSpecialBulkloadFeatureOn;

    size_t insertOFBufferLeaf;
    size_t insertOFBufferInner;

    size_t deleteOFBufferLeaf;
    size_t deleteOFBufferInner;
...
public:
    ...
    */
     ...
     */
    CBPTree(Disk* disk, size_t sizeKey, size_t sizeData, size_t nodeSize, bool isSpecialBulkloadFeatureOn = false);
    ...
    virtual ~CBPTree() = default;
    CBPTree() = default;
    CBPTree(const CBPTree&) = default;
    CBPTree& operator=(const CBPTree&) = default;
    CBPTree(CBPTree &&) = default;
    CBPTree& operator=(CBPTree &&) = default;
};

...
public:
    ...
    */
     ...
     */
    BBPTree(Disk* disk, size_t sizeKey, size_t sizeData, size_t nodeSize, bool isSpecialBulkloadFeatureOn = false);
     ...
     *
     * @return number of entries in BBPTree
     */
    size_t getNumEntries() const noexcept(true) override;

    /**
     * @brief Get BBPTree Height
     *
     * @return BBP Height
     */
    ...
    virtual ~BBPTree() = default;
    BBPTree() = default;
    BBPTree(const BBPTree&) = default;
    BBPTree& operator=(const BBPTree&) = default;
    BBPTree(BBPTree &&) = default;
    BBPTree& operator=(BBPTree &&) = default;
};
